  ...
  return (
    <div className="container" style={{ padding: '3rem 0' }}>
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 800, marginBottom: '0.5rem' }}>Global Order Matrix</h1>
        <p style={{ color: 'var(--text-secondary)' }}>{orders.length} total system transactions</p>
      </div>

      {loading ? (
        <div className="glass-panel" style={{ padding: '4rem', textAlign: 'center', color: 'var(--primary-color)' }}>Synchronizing order data...</div>
      ) : orders.length === 0 ? (
        <div className="glass-panel" style={{ padding: '4rem', textAlign: 'center', color: 'var(--text-secondary)' }}>No orders found in the system.</div>
      ) : (
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <select
                    ...
                    style={{ background: 'rgba(0,0,0,0.5)', border: `1px solid ${statusColor(order.status)}`, color: statusColor(order.status), padding: '0.4rem 0.75rem', borderRadius: '8px', cursor: 'pointer', fontWeight: 700, fontSize: '0.85rem' }}
                  >
