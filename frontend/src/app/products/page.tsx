  ...
  return (
    <div className="container" style={{ padding: '2rem 0' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        {/* Header & Search */}
        <div className="glass-panel" style={{ padding: '2rem', display: 'flex', flexWrap: 'wrap', gap: '2rem', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h1 style={{ fontSize: '2.5rem', color: 'var(--text-primary)', marginBottom: '0.5rem' }}>Core Inventory</h1>
            <p style={{ color: 'var(--text-secondary)' }}>Browse the complete futuristic collection</p>
          </div>
          <div style={{ flex: '1 1 300px', maxWidth: '500px' }}>
            <input 
              ...
              style={{ background: 'rgba(0,0,0,0.3)', padding: '1rem 1.5rem', borderRadius: '30px' }}
            />
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
          ...
          {/* Filters Sidebar */}
          <aside className="glass-panel" style={{ width: '250px', padding: '1.5rem', flexShrink: 0 }}>
            <h3 style={{ fontSize: '1.2rem', marginBottom: '1.5rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.75rem' }}>Categories</h3>
          ...
          <div style={{ flex: 1 }}>
            {loading ? (
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '2rem' }}>
                {Array(6).fill(0).map((_, i) => <div key={i} className="glass-panel" style={{ height: '350px' }}></div>)}
              </div>
              ...
              <div className="glass-panel" style={{ padding: '4rem', textAlign: 'center' }}>
                <h3 style={{ color: 'var(--text-secondary)', fontSize: '1.5rem' }}>No modules found matching your query.</h3>
              </div>
            )}
          </div>
        </div>
