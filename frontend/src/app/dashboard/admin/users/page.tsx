...
export default function AdminUsersPage() {
  ...
  const handleDelete = async (id: string) => {
    if (
      !confirm("This action will permanently delete this user. Are you sure?")
    )
      return;
    try {
      ...
      >
        <div>
          ...
          <p style={{ color: "var(--text-secondary)" }}>
            {users.length} identities registered in the system
          </p>
        </div>
        <div
          style={{
        ...
        >
          ...
          <span
            style={{ color: "#ffcc00", fontSize: "0.85rem", fontWeight: 600 }}
          >
            ADMIN CLEARANCE
          </span>
        </div>
